...
public class Room implements AutoCloseable{
    ...
    protected synchronized void sendMessage(ServerThread sender, String message) {
        ...
        String formatting = message.replaceAll("\\*\\*(.*?)\\*\\*", "<b>$1</b>")    
                            ...
                            .replaceAll("#r(.*?)r#", "<red>$1</red>")        
                            .replaceAll("#b(.*?)b#", "<blue>$1</blue>")                    // ovp 11/14
                            .replaceAll("#g(.*?)g#", "<green>$1</green>"); 
    ...
    public void rollCommand(ServerThread sender, int numDice, int numSides)
    {
        ...
        {                                               //ovp 11/14
            ...
            sendMessage(null, String.format("%s rolled %dd%d and got %d", sender.getClientName(), numDice, numSides, num));
            return;
        }
